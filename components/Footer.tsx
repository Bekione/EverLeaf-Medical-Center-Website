        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <div className="flex gap-4">
              {/* Facebook */}
              <a
                href="https://facebook.com/everleafmedical"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-all hover:scale-110"
              ...
              {/* LinkedIn */}
              <a
                href="https://linkedin.com/company/everleafmedical"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-all hover:scale-110"
              ...
              {/* Instagram */}
              <a
                href="https://instagram.com/everleafmedical"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* YouTube */}
              <a
                href="https://youtube.com/@everleafmedical"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-all hover:scale-110"
              ...
              {/* Twitter/X */}
              <a
                href="https://twitter.com/everleafmedical"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Twitter"
                className="w-10 h-10 rounded-full flex items-center justify-center hover:bg-primary hover:text-white transition-all hover:scale-110"
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                <input
                  ...
                  className="w-full rounded-lg px-4 py-2 text-white text-sm focus:outline-none focus:border-primary transition-colors disabled:opacity-50"
                  style={{
