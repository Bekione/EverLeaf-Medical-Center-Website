    ...
    <div className="animate-fade-in">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600">
              We specialize in diagnosing and treating a wide range of childhood
              conditions, ensuring your child grows up healthy and strong. Our
              approach focuses on preventive care and early intervention.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-slate-500">
                Diagnosis and treatment of common infections, fevers, flu, and
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-slate-500">
                Comprehensive immunization schedules to protect your child from
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-slate-500">
                Monitoring growth milestones and providing early intervention
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-slate-500">
                Expert guidance on breastfeeding, formula, introduction to
                solids, and healthy eating habits.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-100">
                    <div className="p-6 md:p-8 hover:bg-slate-50 transition-colors">
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed mb-4">
                        ...
                        newborns immediately after delivery and in the first few
                        weeks of life.
                      </p>
                    ...
                    <div className="p-6 md:p-8 hover:bg-slate-50 transition-colors border-t border-slate-100">
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed mb-4">
                        Surgical care for children ranging from minor procedures
                        to complex operations, performed by specialized
                        pediatric surgeons.
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-center gap-2 text-sm text-slate-500">
                    ...
                    <div className="p-6 md:p-8 hover:bg-slate-50 transition-colors border-t border-slate-100">
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed mb-4">
                        Specialized care addressing the physical, psychological,
                        and social needs of teenagers and young adults.
                      </p>
                      <ul className="space-y-2">
                        <li className="flex items-center gap-2 text-sm text-slate-500">
                          <span className="material-icons text-green-500 text-xs">
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <span className="inline-block px-3 py-1 mb-4 text-xs font-semibold tracking-wider bg-white/10 text-white rounded-full uppercase border border-white/20">
            Taking New Patients
          </span>
          ...
          <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
            Give your child the gift of good health. Our easy online scheduling
            makes it convenient to find a time that works for your family.
          </p>
