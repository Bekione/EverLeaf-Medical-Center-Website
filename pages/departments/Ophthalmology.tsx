      ...
      <section className="py-10 bg-primary/5 border-b border-slate-100">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { val: "15k+", label: "Surgeries Performed" },
              { val: "98%", label: "Success Rate" },
              { val: "20+", label: "Specialized Doctors" },
          ...
          <Reveal threshold={0.1}>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-slate-600">
                We provide comprehensive diagnosis and treatment for a wide
                range of ocular conditions affecting patients of all ages.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                icon: "blur_on",
                color: "blue",
                desc: "Clouding of the eye's natural lens, leading to decreased vision. We offer advanced laser-assisted cataract surgery.",
              },
              {
                title: "Glaucoma",
                icon: "visibility_off",
                color: "teal",
                desc: "A group of eye conditions that damage the optic nerve. Early detection and treatment are crucial to prevent vision loss.",
              },
              {
                title: "Macular Degeneration",
                icon: "center_focus_weak",
                color: "orange",
                desc: "Age-related condition affecting the central part of the retina. We provide therapies to slow progression and manage symptoms.",
              },
              {
                title: "Diabetic Retinopathy",
                icon: "bloodtype",
                color: "red",
                desc: "A complication of diabetes that affects the eyes. We offer regular screenings and advanced treatments like laser photocoagulation.",
              },
            ].map((item, i) => (
              <Reveal key={i} delay={i * 100} threshold={0.1}>
                <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 group h-full">
                  <div
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
              {[
                ...
                <Reveal key={i} delay={i * 100} threshold={0.1}>
                  <div className="flex gap-4 p-4 rounded-lg hover:bg-slate-50 transition-colors h-full">
            ...
            <Reveal from="left" threshold={0.1} className="lg:w-1/2">
              <div>
                ...
                <p className="text-slate-300 text-lg mb-8 leading-relaxed">
                  ...
                  optical technologies to ensure accurate diagnoses and
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400">
                          ...
                          cross-section pictures of your retina, allowing us to
                          see each distinct layer.
                        </p>
                      </div>
                    </div>
                  </Reveal>
