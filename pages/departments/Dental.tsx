  ...
  return (
    <div className="animate-fade-in">
            ...
            <div className="max-w-2xl">
              ...
              <Reveal delay={200}>
                <p className="text-lg text-slate-600 leading-relaxed max-w-2xl mb-8">
                  Our specialized dental clinic combines advanced technology
                  with compassionate care to ensure your smile is healthy and
            ...
            <Reveal from="left" threshold={0.1}>
              <div>
                ...
                <p className="text-slate-300 mb-8 leading-relaxed">
                  We invest in the latest dental technologies to provide
                  accurate diagnoses and effective treatments. Our modern
                  facility is equipped to handle all your dental needs with
                  precision.
                </p>
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 mt-1">
                        Low-radiation imaging for detailed views of teeth and
                        jaw structure instantly.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-4">
      ...
      <section className="py-24 relative overflow-hidden" id="appointment">
        <div className="absolute inset-0 bg-linear-to-br from-cyan-900 to-slate-900"></div>
        <div
          className="absolute inset-0 opacity-10"
          style={{
            backgroundImage:
