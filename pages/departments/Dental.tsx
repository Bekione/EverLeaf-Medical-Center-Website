  ...
  return (
    <div className="animate-fade-in">
      ...
      <TechnologySection
        ...
        rightContent={
          <div className="relative h-full min-h-[300px] rounded-2xl overflow-hidden shadow-2xl border-4 border-border transform lg:rotate-2 hover:rotate-0 transition-all duration-500">
            <CldImg
