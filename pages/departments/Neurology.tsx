            ...
            <div className="max-w-2xl">
              ...
              <Reveal delay={100}>
                <h1 className="text-4xl lg:text-5xl font-serif font-bold text-slate-900 mb-6 leading-tight">
                  ...
                  <span className="text-primary">Brain Health</span>
                </h1>
              </Reveal>
              <Reveal delay={200}>
                <p className="text-lg text-slate-600 leading-relaxed mb-8 max-w-lg">
                  Our Neurology Department provides world-class diagnosis and
                  treatment for complex disorders of the nervous system. We
                  combine cutting-edge technology with compassionate care.
                </p>
              </Reveal>
              <Reveal delay={300}>
          ...
          <Reveal threshold={0.1}>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-slate-600">
                Our specialists have extensive experience in diagnosing and
                managing a wide range of neurological conditions.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                icon: "bolt",
                color: "red",
                desc: "Rapid response stroke care with thrombolytic therapy and comprehensive rehabilitation programs.",
              },
              {
                title: "Epilepsy",
                icon: "insights",
                color: "yellow",
                desc: "Advanced seizure management, EEG monitoring, and surgical options for epilepsy control.",
              },
              {
                title: "Alzheimer's",
                icon: "psychology_alt",
                color: "blue",
                desc: "Compassionate care for memory disorders, early diagnosis, and support for patients and families.",
              },
              {
                title: "Migraine",
                icon: "healing",
                color: "purple",
                desc: "Specialized headache clinic offering personalized treatment plans for chronic migraines and headaches.",
              },
            ].map((item, i) => (
                  ...
                  {[
                    {
                      ...
                      desc: "A non-invasive test that records electrical patterns of the brain, essential for diagnosing epilepsy and other brain disorders.",
                      icon: "monitor_heart",
                    },
                    {
                      title: "Nerve Conduction Studies",
                      desc: "Tests to measure how fast an electrical impulse moves through your nerve, used to identify nerve damage.",
                      icon: "electrical_services",
                    },
                    {
                      title: "Neurorehabilitation",
                      desc: "A complex medical process which aims to aid recovery from a nervous system injury, and to minimize and/or compensate for any functional alterations.",
                      icon: "accessibility",
                    },
                  ].map((service, i) => (
                    <Reveal key={i} delay={i * 100} threshold={0.1}>
              ...
              <div className="bg-slate-50 rounded-3xl p-8 lg:p-10 border border-slate-100 h-full">
                ...
                <div className="space-y-8">
                  <div className="relative overflow-hidden rounded-xl bg-white p-6 shadow-sm border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm relative z-10">
                      Provides exceptional image quality for detailed brain and
                      spine imaging, allowing for earlier and more accurate
                  ...
                  <div className="relative overflow-hidden rounded-xl bg-white p-6 shadow-sm border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm relative z-10">
                      Combines a CT scan with an injection of dye to produce
                      pictures of blood vessels and tissues, crucial for stroke
                      assessment.
                    </p>
                  </div>
                </div>
                <div className="mt-8 pt-8 border-t border-slate-200">
                  <p className="text-slate-500 text-sm italic">
                    "We invest in the latest technology to ensure our patients
                    have access to the most precise diagnostic tools available."
                  </p>
                </div>
              </div>
            </Reveal>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Reveal delay={100}>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6 leading-tight">
                Ready for Your <br />
                <span className="text-indigo-300">Neurology Consultation?</span>
              </h2>
            </Reveal>
            <Reveal delay={200}>
              <p className="text-indigo-100 text-lg md:text-xl mb-10 leading-relaxed max-w-2xl mx-auto">
                Early diagnosis can make a significant difference. Schedule an
