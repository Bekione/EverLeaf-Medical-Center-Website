    ...
    <div className="animate-fade-in">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden lg:flex w-full justify-center">
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border-4 border-white transform rotate-2 hover:rotate-0 transition-transform duration-500 max-h-[450px] w-full max-w-lg">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAQXOFccHeKdEh_AQZ9fws6JVXcLa6Iz8Tjq_V6mWq3W5cl694yBn5T103VW1-42ItCmCCLdeZPgrrgQgykZOoHDGHzlO74VNjsH8Y3PaQIFBF0UvYBOup-bvxdiig-Gki9OWOSmTEzWcG7httWSR6JQdnFiRXVmjK-jgylNUqdE7vVO0Fkd10Ic9-0ZP70XpBoPjP5UteM9M2FABRZ6XCixyHmUBi0wTaukSccpmN4nabsNo01IO4iEeiN3mmSzFrmYUoeDmDNeeg" alt="Cardiology Team" className="w-full h-full object-cover" />
              </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Coronary Artery Disease', icon: 'favorite', color: 'red', desc: 'Treatment for narrowed or blocked blood vessels that can lead to heart attack.' },
              { title: 'Heart Failure', icon: 'water_drop', color: 'blue', desc: 'Comprehensive management plans for chronic heart failure conditions.' },
              { title: 'Arrhythmia', icon: 'show_chart', color: 'orange', desc: 'Expert care for irregular heartbeats, including atrial fibrillation.' },
              { title: 'Valvular Heart Disease', icon: 'change_circle', color: 'purple', desc: 'Repair and replacement therapies for damaged heart valves.' }
            ].map((item, i) => (
              ...
              <div key={i} className="bg-white rounded-2xl overflow-hidden shadow-card hover:shadow-xl transition-all duration-300 group">
                <div className="h-64 overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                    <button
                      onClick={() => openAppointment({ doctorName: doc.name, department: 'Cardiology' })}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-[0.03] pointer-events-none">
          <span className="material-icons text-[20rem] text-white">favorite</span>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6 leading-tight">
              Prioritize Your <br /><span className="text-blue-300">Heart Health</span> Today
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+15551234567" className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white border border-white/30 rounded-full hover:bg-white/10 backdrop-blur-sm transition-all">
                Call (555) 123-4567
              </a>
            </div>
          </div>
