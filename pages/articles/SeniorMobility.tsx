        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-8">
            <header className="mb-10">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                  <span className="inline-block px-3 py-1 text-xs font-bold tracking-wider text-blue-600 uppercase bg-blue-50 rounded-full border border-blue-100">Research</span>
                  <span className="text-sm text-slate-500 flex items-center gap-1"><span className="material-icons text-sm">schedule</span> 7 min read</span>
                </div>
              ...
              <h1 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-6 leading-tight">Mobility in Seniors: The Link Between Walking and Cognitive Health</h1>
              <p className="text-xl text-slate-600 leading-relaxed font-serif italic border-l-4 border-blue-500 pl-4">New studies suggest that maintaining physical mobility may be a key factor in preserving memory and cognitive function in older adults.</p>
            </header>

            <div className="rounded-2xl overflow-hidden mb-12 shadow-card">
              <img src="https://images.unsplash.com/photo-1555814965-74d430d12197?w=1200&q=80" alt="Senior Walking" className="w-full h-[400px] object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-8 flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left">
              <div className="w-24 h-24 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 flex-shrink-0">
                <span className="material-icons text-4xl">person</span>
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">Dr. Robert Turner</h3>
                <p className="text-primary font-medium text-sm mb-3">Geriatric Specialist</p>
                <p className="text-slate-600 text-sm leading-relaxed mb-4">
                  Dr. Turner has dedicated his career to studying the aging process. His research focuses on lifestyle interventions that prolong cognitive vitality in seniors.
                </p>
          ...
          <aside className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-gradient-to-br from-slate-900 to-blue-900 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden">
              ...
              <p className="text-blue-100 text-sm mb-6 relative z-10">Get the latest research delivered to your inbox.</p>
