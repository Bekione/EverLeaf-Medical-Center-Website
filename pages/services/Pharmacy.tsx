          ...
          <Reveal threshold={0.1}>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-slate-600">
                ...
                provide a wide range of pharmacy services tailored to your
                health needs.
              </p>
            </div>
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {[
              ...
              <Reveal key={i} delay={i * 100} threshold={0.1}>
                ...
                >
                  <div
                    className={`shrink-0 w-16 h-16 bg-${service.color}-50 rounded-xl flex items-center justify-center text-${service.colorName} group-hover:scale-110 transition-transform duration-300`}
                  >
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div>
                  ...
                  <p className="text-slate-600 mb-6 leading-relaxed">
                    ...
                    state-of-the-art robotic dispensing systems to minimize
                    human error and conduct rigorous quality checks on every
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500">
                          Every prescription is verified by three separate
                          checks.
                        </p>
                      </div>
                    </div>
