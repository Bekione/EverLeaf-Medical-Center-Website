      ...
      >
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            >
              Before any treatment plan begins, understanding the root cause is
              essential. Our Diagnostic Center operates with a philosophy of
              "Precision First," ensuring that every scan, test, and analysis
              contributes to a clear path forward for your health journey.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div
              className="p-6 rounded-xl border hover:shadow-lg transition-all duration-300 group cursor-pointer flex flex-col"
              style={{
            ...
            >
              <div
                className="w-12 h-12 rounded-lg flex items-center justify-center text-primary mb-4 shadow-sm group-hover:scale-110 transition-transform"
                style={{ backgroundColor: "var(--color-surface)" }}
              >
              ...
              <p className="text-sm text-slate-500 mb-4 flex-grow">
                High-definition MRI (3T), 64-slice CT Scans, and Digital X-Rays
                for detailed anatomical views.
              </p>
            ...
            >
              <div
                className="w-12 h-12 rounded-lg flex items-center justify-center text-teal-500 mb-4 shadow-sm group-hover:scale-110 transition-transform"
                style={{ backgroundColor: "var(--color-surface)" }}
              >
              ...
              <p className="text-sm text-slate-500 mb-4 flex-grow">
                Fully automated laboratory providing accurate results for
            ...
            >
              <div
                className="w-12 h-12 rounded-lg flex items-center justify-center text-red-500 mb-4 shadow-sm group-hover:scale-110 transition-transform"
                style={{ backgroundColor: "var(--color-surface)" }}
              >
              ...
              <p className="text-sm text-slate-500 mb-4 flex-grow">
                Specialized testing to monitor heart health and detect
                cardiovascular issues early.
              </p>
              <ul className="text-sm text-slate-600 space-y-2 mt-auto">
                <li className="flex items-center gap-2">
                  <span className="material-icons text-green-500 text-xs">
            ...
            >
              ...
              <p className="text-sm text-slate-500 mb-4 flex-grow">
                Evaluation of the nervous system function to assist in
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              className="p-8 rounded-2xl relative overflow-hidden group transition-colors"
