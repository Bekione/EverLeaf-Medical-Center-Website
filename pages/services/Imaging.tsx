...
import ImpactBannerSection from "../../components/ImpactBannerSection";
    ...
    <div className="animate-fade-in">
      ...
      <section className="py-16 md:py-24 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <MediaGridSection
            id="procedures"
            title={t("pages.services.imaging.intro.title")}
            description={t("pages.services.imaging.intro.description")}
            items={[
              {
                ...
                image: "/images/imaging-body-1.jpg",
                color: "primary",
              },
              {
                ...
                image: "/images/imaging-body-2.jpg",
                color: "teal-600",
              },
              {
                ...
                image: "/images/imaging-body-3.jpg",
                color: "indigo-600",
              },
              {
                ...
                image: "/images/imaging-body-4.jpg",
                color: "purple-600",
              },
            ]}
          />
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-center text-sm text-slate-600">
                          <span className="material-icons text-secondary text-base mr-2 shrink-0">
                            check_circle
                          </span>
                          {t(
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-center text-sm text-slate-600">
                          ...
                          {t(
                            "pages.services.imaging.specialized.women.items.0",
                          )}
                        </li>
                        <li className="flex items-center text-sm text-slate-600">
                          <span className="material-icons text-secondary text-base mr-2 shrink-0">
                          ...
                          {t(
                            "pages.services.imaging.specialized.women.items.1",
                          )}
                        </li>
                      </ul>
                    </div>
          ...
          <ImpactBannerSection
            title={t("pages.services.imaging.results.title")}
            description={t("pages.services.imaging.results.description")}
            items={[
              {
                icon: "lock",
                text: t("pages.services.imaging.results.items.0"),
              },
              {
                icon: "history",
                text: t("pages.services.imaging.results.items.1"),
              },
              {
                icon: "share",
                text: t("pages.services.imaging.results.items.2"),
              },
            ]}
            button={{
              label: t("pages.services.imaging.results.button"),
              to: buildPath("/contact"),
              variant: "white",
            }}
            image="/images/imaging-body-5.jpg"
            imageAlt={t("common.imgAlt.doctorReviewingDigitalScan")}
          />
        </div>
      </section>
