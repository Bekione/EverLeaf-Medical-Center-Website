        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600">
              ...
              disciplines to support accurate diagnosis and effective treatment
              plans.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              className="p-8 rounded-2xl shadow-card border group hover:-translate-y-1 transition-all duration-300"
              style={{
            ...
            >
              ...
              <p className="text-slate-500 mb-4 leading-relaxed">
                Advanced analysis of chemical components in blood and body
                fluids. Liver function, kidney profiles, and lipid panels with
                high precision.
              </p>
            ...
            >
              ...
              <p className="text-slate-500 mb-4 leading-relaxed">
                Identification of infectious agents including bacteria, viruses,
                fungi, and parasites to guide appropriate antimicrobial therapy.
              </p>
              <ul className="space-y-2 mb-6">
                {[
                  "Culture & Sensitivity",
            ...
            >
              ...
              <p className="text-slate-500 mb-4 leading-relaxed">
                Detailed study of blood and blood-forming tissues to diagnose
                anemia, infections, leukemia, and clotting disorders.
              </p>
              <ul className="space-y-2 mb-6">
                {[
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="lg:w-1/2 order-1 lg:order-2">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">
                ...
                laboratory technology. We utilize fully automated analyzers from
                world-leading manufacturers to eliminate human error and ensure
                consistency.
              </p>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white/80 text-lg md:text-xl mb-10 leading-relaxed max-w-2xl mx-auto">
              Book your lab test today. Choose from our wide range of individual
