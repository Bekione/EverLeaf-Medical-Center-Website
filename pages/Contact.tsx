              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row gap-8">
                  <div>
                    ...
                    <p className="text-xl font-bold text-slate-800">+251 954 123-456</p>
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-slate-500">Visitor parking garage is available on 4th Ave (5 Br/hr). Valet service available at main entrance.</p>
              </div>
            </div>
          </div>
        </div>
