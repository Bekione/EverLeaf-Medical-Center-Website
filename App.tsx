      ...
      <HashRouter>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="departments/pediatrics" element={<Navigate to="/doctors" />} /> {/* Placeholder */}
            
            {/* Service Routes */}
            <Route path="services/preventive-checkups" element={<PreventiveCheckups />} />
            <Route path="services/diagnostics" element={<Radiology />} /> {/* Reusing Radiology for Diagnostics */}
